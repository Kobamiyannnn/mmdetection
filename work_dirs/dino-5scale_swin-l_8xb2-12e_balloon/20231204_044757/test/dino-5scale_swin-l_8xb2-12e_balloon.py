...
default_hooks = dict(
    ...
    visualization=dict(
        _scope_='mmdet',
        draw=True,
        test_out_dir='epoch_9-result_images/',
...
launcher = 'none'
load_from = 'work_dirs/dino-5scale_swin-l_8xb2-12e_balloon/epoch_9.pth'
log_level = 'INFO'
log_processor = dict(
...
work_dir = 'work_dirs/dino-5scale_swin-l_8xb2-12e_balloon/20231204_044757/test/'
