_base_ = "../../projects/CO-DETR/configs/codino/co_dino_5scale_swin_l_16xb1_3x_coco.py"
...
data_root = "data/dashcam_footage/"  # defined in common/ssj_scp_270k_coco-instance.py
metainfo = {
    "classes": (
        "banner",
        "bicycle",
...
train_dataloader = dict(
    ...
    num_workers=2,  # defined in co_dino_5scale_swin_l_16xb1_1x_coco.py
    dataset=dict(
        data_root=data_root,  # defined in co_dino_5scale_r50_8xb2_1x_coco.py
        metainfo=metainfo,
        # defined in co_dino_5scale_r50_8xb2_1x.py
        ann_file="2140_dataset/annotations/annotation_train.json",
        # defined in common/ssj_scp_270k_coco-instance.py
        data_prefix=dict(img="2140_dataset/train/")
    ),
)
val_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file="2140_dataset/annotations/annotation_val.json",
        data_prefix=dict(img="2140_dataset/val/"),
    ),
)
...
val_evaluator = dict(
    # defined in common/ssj_270k_coco-instance.py
    ann_file=data_root + "2140_dataset/annotations/annotation_val.json",
...
load_from = "https://download.openmmlab.com/mmdetection/v3.0/codetr/co_dino_5scale_swin_large_3x_coco-d7a6d8af.pth"  # noqa
...
# defined in co_dino_5scale_r50_lsj_8xb2_1x_coco.py
# (batch size: 1) * (accumulation_counts: 4)
